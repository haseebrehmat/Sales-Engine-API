...
class CandidateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        data = [CandidateTools(candidate_id=qs.id, tool_id=tool, experience_level=1) for tool in tools]
    ...
    def update(self, instance, validated_data):
        ...
        CandidateSkills.objects.bulk_create(data, ignore_conflicts=True)
        data = [CandidateTools(candidate_id=instance.id, tool_id=tool, experience_level=1) for tool in tools]
        CandidateTools.objects.bulk_create(data, ignore_conflicts=True)
        return instance
